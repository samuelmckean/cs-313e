...
#  Description: Series of recursion exercises in sorting groups of integers
...
def groupSum6(start, nums, target):
    ...
    # recursive case
        ...
        return (groupSum6(start + 1, nums, target - nums[start]) 
                or groupSum6(start + 1, nums, target))
...
def groupSum5(start, nums, target):
    ...
    # recursive cases
        ...
        if nums[start] % 5 == 0:    # value is a multiple of 5
            if start + 1 < len(nums) and nums[start + 1] == 1:  # not at the end of list and next value is 1
                return groupSum5(start + 2, nums, target - nums[start]) # return recursive call skipping next character
            return groupSum5(start + 1, nums, target - nums[start])  # return recursive call at next character
        else:
            return (groupSum5(start + 1, nums, target - nums[start])
                    or groupSum5(start + 1, nums, target))
...
def groupSumClump(start, nums, target):
    ...
    # recursive case
        ...
        same_number_count = 1 
        while start + 1 < len(nums) and nums[start] == nums[start + same_number_count]: 
            same_number_count += 1
        return (groupSumClump(start + same_number_count, nums, target)
                or groupSumClump(start + same_number_count, nums, target - same_number_count * nums[start]))
...
def splitArray(nums):
    ...
    group_2 = []
    index = 0
    return splitArrayHelper(group_1, group_2, nums, index)


def splitArrayHelper(group_1, group_2, nums, index):
    # base case 1
    ...
    # recursive case
        ...
        new_group_1 = group_1[:group_1.index(nums[index])] + group_1[group_1.index(nums[index]) + 1:] 
        new_group_2 = group_2[:] + [group_1[group_1.index(nums[index])]] 
        return (splitArrayHelper(group_1, group_2, nums, index + 1)
                or splitArrayHelper(new_group_1, new_group_2, nums, index + 1))
...
def splitOdd10(nums):
    ...
    group_2 = []
    index = 0
    return splitOdd10Helper(group_1, group_2, nums, index)

  
def splitOdd10Helper(group_1, group_2, nums, index):
    # base case 1
    if (sum(group_1) % 10 == 0 and sum(group_2) % 2 == 1 
        or sum(group_2) % 10 == 0 and sum(group_1) % 2 == 1):
        return True
    # base case 2
    elif index >= len(nums):
        return False
    # recursive case
        ...
        return (splitOdd10Helper(group_1, group_2, nums, index + 1)
                or splitOdd10Helper(group_1[:group_1.index(nums[index])] + group_1[group_1.index(nums[index])+1:],
                                    group_2 + [group_1[group_1.index(nums[index])]],
                                    nums,
                                    index + 1))
...
def split53(nums):
    ...
    group_2 = []
    index = 0
    return split53Helper(group_1, group_2, nums, index)

def split53Helper(group_1, group_2, nums, index):
    # base case 1
    if sum(group_1) == sum(group_2):
        return True
    # base case 2
    ...
    # recursive case
        ...
        new_group_2 = group_2 + [group_1[group_1.index(nums[index])]]
        if nums[index] % 5 == 0:
            return split53Helper(group_1, group_2, nums, index + 1)
        elif nums[index] % 3 == 0:
            return split53Helper(new_group_1, new_group_2, nums, index + 1)
        return (split53Helper(group_1, group_2, nums, index + 1)
                or split53Helper(new_group_1, new_group_2, nums, index + 1))
